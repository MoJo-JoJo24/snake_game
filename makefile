...
release: ./test/play_snake_game.cpp ./src/display_snake.cpp ./src/snake_body.cpp ./src/snake_game.cpp ./src/score_database.cpp
...
play_snake_game.out : ./test/play_snake_game.cpp ./src/score_database.cpp ./src/display_snake.cpp ./src/snake_body.cpp ./src/snake_game.cpp
	$(CC) $(CPPFLAGS) -I $(INCLUDE) $^ -o $@ -lsfml-graphics -lsfml-window -lsfml-system
